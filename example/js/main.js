...
let config = {
    env: "development",
    PROJECT:  true ? __webpack_require__.i({"baseUrl":"http://example.com"}).PROJECT : window.globalConfigs.GLOBAL.PROJECT,
    VERSION:  true ? __webpack_require__.i({"baseUrl":"http://example.com"}).VERSION : window.globalConfigs.GLOBAL.VERSION,
    doc_title: '',
    baseUrl:  true ? "http://example.com" : window.globalConfigs.GLOBAL.baseUrl,
...
Component.options.__file = "/Users/yishide/Desktop/前端学习资料/vue-model/src/components/app.vue"
...
__WEBPACK_IMPORTED_MODULE_0_vue__["default"].prototype.$Config = __WEBPACK_IMPORTED_MODULE_3__config_config__["a" /* default */];
...
window.EventBus = new __WEBPACK_IMPORTED_MODULE_0_vue__["default"]();
...
const routers = [{
    ...
    path: '/guide',
    name: 'guide',
    component: resolve => __webpack_require__.e/* require */(0).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(47)]; (resolve.apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__));}.bind(this)).catch(__webpack_require__.oe),
    meta: {
        title: '导航'
    }
}];
...
var update = __webpack_require__(17)("d16685da", content, false);
